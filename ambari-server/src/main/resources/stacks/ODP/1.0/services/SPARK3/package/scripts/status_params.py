...
spark_user = config['configurations']['spark3-env']['spark_user']
spark_group = config['configurations']['spark3-env']['spark_group']
...
spark_pid_dir = config['configurations']['spark3-env']['spark_pid_dir']
